...
/* router.get('/teste', function (req, res) {
	...
	request.get('https://portfoli-api.herokuapp.com/user/memberinfo', options, function (err, res, body) {
		console.log(res);
	}); */
/*request.get({
...
router.post('/nifvalidation', function(req, res) {
	...
	if (tipo_investidor === "private") {
		...
		request.post({
			...
			url: 'https://portfoli-api.herokuapp.com/user/nifvalidation',
			body: bodyText
		}, function(error, response, body) {
...
router.post('/investidor_privado', function(req, res) {
	...
	request.post({
		headers: { 'content-type': 'application/x-www-form-urlencoded', 'authorization': id_gerado },
		url: 'https://portfoli-api.herokuapp.com/user/investidor_privado',
		body: bodyText
	}, function(error, response, body) {
		console.log(body);
...
router.post('/investidor_coletivo', function(req, res) {
	...
	request.post({
		headers: { 'content-type': 'application/x-www-form-urlencoded', 'authorization': id_gerado },
		url: 'https://portfoli-api.herokuapp.com/user/investidor_coletivo',
		body: bodyText
	}, function(error, response, body) {
		console.log(body);
...
router.post('/business_idea', function(req, res) {
	...
	request.post({
		headers: { 'content-type': 'application/x-www-form-urlencoded', 'authorization': id_gerado },
		url: 'https://portfoli-api.herokuapp.com/user/business_idea',
		body: bodyText
	}, function(error, response, body) {
		console.log(body);
		res.render('investor_colective_form');
